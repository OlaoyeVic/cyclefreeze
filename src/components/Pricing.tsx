      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-8">
          {plans.map((plan, index) => (
            <div
              key={index}
              className={`h-[877px] bg-white rounded-3xl shadow-lg max-w-sm border border-${plan.color}-500 relative`}
            >
              <div
                className={`h-[180px] rounded-t-3xl p-8 py-12 text-center relative`}
                style={{ backgroundColor: plan.color }}
              >
                <h3 className={`text-[24px] font-normal text-white my-6`}>
                  {plan.title}
                </h3>
                ...
                >
                  <div
                    className="flex items-center justify-center p-2 rounded-[20px]"
                    style={{ backgroundColor: plan.color }}
                  >
              ...
              <div className="pt-20 mx-8">
                <p className="text-center pt-3 pb-6 font-normal text-[12px]">
                  {plan.desc}
                </p>
                <ul className="space-y-4 px-2 mb-8">
                  {plan.features.map((feature, i) => (
                    ...
                    >
                      ...
                      <span className="text-gray-800 font-normal text-[12px]">
                        {feature}
                      </span>
                    </li>
                  ))}
